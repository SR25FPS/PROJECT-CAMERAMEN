...
<body>
    ...
    <div class="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $start_time = $_POST['start_time']; // Changed from timeframe to start_time
            ...
            // Prepare and bind
            $stmt = $conn->prepare("INSERT INTO general_data (priority_id, reservedby, facility_id, start_time, end_time, event) VALUES (?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("isssss", $next_priority_id, $reservedby, $facility_id, $start_time, $end_time, $event);
