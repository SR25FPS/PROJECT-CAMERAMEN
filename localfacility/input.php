            ...
            <form action="process_input.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select id="facility_id" name="facility_id" required>
                        ...
                        <option value="Benches (Near Admin)">Benches (Near Admin)</option>
                        <option value="Benches (Near Pond)">Benches (Near Pond)</option>
                        <option value="Highschool Auditorium">Highschool Auditorium</option>
                        <option value="Green Room">Green Room</option>
                        <option value="A301">A 301</option>
                        ...
                        <option value="Chess Room">Chess Room</option>
                    </select>
                </div>
                <div class="form-group">
